                ...
                <?php
                    ...
                    <table class="table">
                        <tr>    
                            ...
                            <td><b style="color:#3498DB;">Araç Giriş Tarihi</b><br><b> <?php echo $sonuc['arac_giris_tarih'] ?><br><br></b> <input type="text" name="arac_cikis_tarih" class="form-control" value="<?php echo date('d-m-Y H:i:s') ?>"></td>
                        </tr>
                    </table>
